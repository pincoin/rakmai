$(document).ready(function () {
    $('.summernote-widget').each(function (index) {
                    ...
                    $.ajax({
                        ...
                        $.each(data.files, function (index, file) {
                            ...
                            $('#thumbnail-list').append(
                                ...
                                '    <div class="card-body">\n' +
                                '      <img class="card-img-top message-thumbnail-image" src="' + file.url + '">\n' +
                                '    </div>\n' +
                                '    <div class="card-footer text-center">\n' +
                                '      <a href="#" id="thumbnail-' + file.uid + '"\n' +
                                '           class="btn-sm btn-danger message-thumbnail-delete-button">Delete</a>\n' +
                                '    </div>\n' +
                                '  </div>\n' +
                                '</div>');
        ...
        $(document).on('click', '.message-thumbnail-image', function () {
            // Insert image into the editor when clicked thumbnail images
            $sn.summernote('insertImage', $(this).attr('src'));
        });

        $(document).on('click', '.message-thumbnail-delete-button', function () {
