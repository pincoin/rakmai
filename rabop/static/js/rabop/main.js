$(document).ready(function () {
  ...
  var messages = [
    ...
    "환불은 미사용에 한하여 요청일로부터 은행영업일 기준 3~5일 이후 환불 수수료 500원 제외하고 입금됩니다.\n\n교환 역시 3~5일 소요되므로 환불 요청해주시고 필요한 상품권은 별도로 주문 결제해주세요\n\n감사합니다.\n\n",
  ...
  var sms_messages = [
    "[핀코인] ",
    "[핀코인] 신분증 사진도 주민번호 뒷자리 가리고 이름/생년월일/주소가 보이게 올려주세요.",
