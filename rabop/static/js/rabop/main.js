$(document).ready(function () {
    ...
    var messages = [
        ...
        '또는 다음에 주문/입금하실 때 차액 빼고 입금해주세요.\n\n단, 이 경우 수동발권처리해야 하므로 오전10시부터 새벽1시 사이에 주문/입금부탁드립니다.\n\n감사합니다.\n\n',
        '처리해드렸습니다. 감사합니다.\n\n',
        '감사합니다.\n\n'
    ];
    ...
    var sms_messages = [
        ...
        '[핀코인] 통장/카드 캡쳐 사진이 아니라 실물 사진으로 번호 가리고 앞면 이름이 보이게 올려주세요.',
